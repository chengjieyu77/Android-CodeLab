...
fun SportsApp(
    ...
    if (contentType ==SportsContentType.ListAndDetail ){
        SportsListAndDetails(
            ...
            contentPaddingInDetail = PaddingValues(16.dp),
            contentPaddingInList = PaddingValues(8.dp)
        )
    }else{
        Scaffold(
            topBar = {
...
private fun SportsDetail(
    ...
    Box(
        modifier = modifier
            ...
            .padding(top = if (contentType == SportsContentType.ListAndDetail) 0.dp else contentPadding.calculateTopPadding())
    ) {
        Column(
            modifier = Modifier
                .padding(
                    ...
                    end = if (contentType == SportsContentType.ListAndDetail) 0.dp else contentPadding.calculateEndPadding(layoutDirection)
                )
        ) {
            Box {
                Box {
...
fun SportsListAndDetails(
    ...
    selectedSport: Sport,
    onBackPressed: () -> Unit,
    contentPaddingInDetail: PaddingValues,
    contentPaddingInList:PaddingValues,
    contentType: SportsContentType
    ...
    Row {
        SportsList(
            ...
            contentPadding = contentPaddingInList
        ...
        SportsDetail(
            ...
            contentPadding = contentPaddingInDetail,
            contentType = contentType,
...
fun SportsListAndDetailsPreview(){
    SportsTheme {
        SportsListAndDetails(
            ...
            onBackPressed = { },
            contentPaddingInDetail = PaddingValues(start = 16.dp),
            contentType = SportsContentType.ListAndDetail,
            contentPaddingInList = PaddingValues(8.dp)
        )
    }
